...
You'd like to add a sample here? Please check conventions on [CONTRIBUTING.md](./CONTRIBUTING.md).

Or are there any problems? Please report on [issue](https://github.com/aKuad/docs-gen-samples/issues).
